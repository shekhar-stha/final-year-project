    ...
    return (
        <>
            ...
            <div className="header-2">
                <nav className="navbar navbar-expand-xl navbar-dark bg-lg-transparent">
                    <div className="container">
                        <Link to="/" className="navbar-brand"><img className="logo" src="https://cdn.asparksys.com/medias/1672403852617.png" alt="logo" /></Link>
                        ...
                        <form className="d-flex ms-3" role="search">
                            ...
                            <div className="profile-navs d-flex ms-auto">
...

                                {
                                     ...
                                     <>
                                         ...
                                         <div className="my-profile dropdown">
                                             <Link className="d-flex align-items-center dropdown-toggle text-white" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div className="login-signup position-relative">
                                    <Link to='/login' className="btn btn-outline-light rounded-1 px-4">
                                        Log in
                                    </Link>

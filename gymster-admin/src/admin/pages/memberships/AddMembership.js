...
export default function AddMembership() {
    const schema = Yup.object().shape({
        ...
        description2: Yup.string()
            .required("Write Description2"),

        description3: Yup.string()
            .required("Write Description3"),

        description4: Yup.string()
            .required("Write Description4"),
    ...
    const publish = async () => {
        try {
            await axios.post('/membership/postMembership', data)
                ...
                <div className="row h-100">
                    ...
                    <div className="col-10 h-100 overflow pb-4">
                        ...
                        <div className="content-side h-auto add-members-page">
                            <h3 className="mb-3 text-secondary">Add Membership</h3>
